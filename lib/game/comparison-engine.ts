...
/**
 * Numeric attributes (age, squadNumber) additionally carry a directional
 * indicator on mismatch, showing whether the target's value is higher or
 * lower than the guessed player's value (REQ-COMPARE-004).
 */
